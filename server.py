...
class TCP_connection_SERVER:
    ...
    def receive_send_file(self, filename, address=False, dest_address=False):
        ...
        f=file(filename,'wb')
        data = str(present_client.recv(self.buffer_size))
...
#                
        ...
        self.send_file("@!fxixlxexT5tx2rxExnxd@!")
        
                
    def send_file(self, addr=False):
...
#        print addr
#        flag=False
#        print TCP_connection_SERVER.clients_addrs
#        clients_addrs=[ (x,(y, z)) for y in TCP_connection_SERVER.clients_addrs if y  == addr[0] ]
#        print clients_addrs
#        print len(clients_addrs)
        ...
        if len(TCP_connection_SERVER.clients_addrs)>1:
            for sending_client, sending_addr in TCP_connection_SERVER.clients_addrs:
                ...
                if sending_addr[0]==addr[0]:
                    ...
                    print "[%s,%s] has lost the connection " % addr
            print i
